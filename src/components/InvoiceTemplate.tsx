...
export default function InvoiceTemplate({
  ...
  const getInvoiceQRSource = () => {
    if (profile?.upiId) {
      ...
      const cleanShopName = profile.shopName ? profile.shopName.trim() : 'Vyapar Mitra';
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center mt-2 mb-3">
          ...
          <img src={appLogo} alt="Vyapar Mitra Logo" className="w-12 h-12 object-contain rounded-lg mb-2 grayscale" />
        ...
        <div className="flex flex-col items-center justify-center text-center mt-3 mb-2 font-sans text-black">
          ...
          <div className="text-[8.5px] text-slate-500 font-bold mt-3 leading-normal">
            ...
            <div className="text-[8px] font-medium tracking-tight mt-0.5">Software Powered by Vyapar Mitra</div>
          </div>
        </div>
              ...
              <div className="flex gap-2.5 items-center">
                <div className="flex items-center justify-center w-10 h-10 shrink-0">
                  {profile?.logo ? (
                    ...
                    <img src={appLogo} alt="Vyapar Mitra Logo" className="w-10 h-10 object-contain" />
                  )}
                </div>
                <div>
        ...
        <div className="flex flex-col mt-2.5 z-10 relative">
          ...
          <div className={`rounded-xl overflow-hidden text-white py-2 px-6 flex justify-between items-center text-[9px] font-bold ${!isBW ? 'bg-[#0B2C56]' : 'bg-black'} relative h-7`}>
            ...
            <div className="flex-1 text-center font-sans">
              ...
              <span className="uppercase text-orange-400 tracking-wider font-extrabold">Vyapar Mitra</span>
              <span className="text-slate-300 font-extrabold"> | www.vyaparmitra.com</span>
            </div>
      ...
      >
        ...
        >
          ...
          <div className="space-y-3">
            ...
            {/* Email */}
            <a
              href={`mailto:?subject=${encodeURIComponent(`Invoice ${bill.invoiceNumber} from ${profile?.shopName || "Vyapar Mitra"}`)}&body=${encodeURIComponent(shareText)}`}
