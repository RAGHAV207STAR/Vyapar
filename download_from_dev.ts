...
function fetchUrlAndFollow(targetUrl: string) {
  ...
  https.get(targetUrl, options, (res) => {
    ...
    res.on('end', () => {
      ...
      fs.writeFileSync('dev_index.html', data);
      console.log('Saved to dev_index.html');
...
const devUrl = 'https://ais-dev-n6p7nzyasm6nifp4xyiedm-989624052375.asia-southeast1.run.app/';
fetchUrlAndFollow(devUrl);
